...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::mat4(1.0f);
		model = glm::rotate(model, 0.78f, glm::vec3(1.0f, 0.0f, 1.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		...
		//// --- Pata 1 ---
		//model = glm::mat4(1.0f);
		//model = glm::translate(model, glm::vec3(1.4f, 0.25f, 0.9f));
		...
		//// --- Pata 1 ---
		//model = glm::mat4(1.0f);
		//model = glm::translate(model, glm::vec3(0.9f, 0.25f, 0.65f));
		//model = glm::scale(model, glm::vec3(0.1f, 0.6f, 0.1f));
		//glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		//glDrawArrays(GL_TRIANGLES, 0, 36);
		//
